...
use super::{AccelOutputDataRate, AccelScale, FifoMode, Interrupt, MagMode, MagOutputDataRate};
...
/// OUT_TEMP_L_A (register `0x0C`)
pub struct OutTempLA;

impl RegRead<u16> for OutTempLA {
...
/// OUTX_L_REG_M (register `0x68`)
pub struct OutxLRegM;

impl RegRead<(u16, u16, u16)> for OutxLRegM {
